...
<details>
   ...
   #### 반응형 웹
   <img src="./src/styles/images/responsive.gif" width="400" alt="responsive" >

   #### Dashboard
   <img src="./src/styles/images/dashboard.gif" width="400" alt="dashboard" >

   #### 회원가입 & 로그인
   <img src="./src/styles/images/auth.gif" width="400" alt="auth" >
   </details>
